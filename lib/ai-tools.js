...
You will call the function searchSpotify(args) using the search query and filters you identify from the user's input.

This function searches Spotify for music tracks, albums, artists, or playlists. You should construct an appropriate search query based on the user's natural language input.

The search query can include:
- Keywords for song titles, artist names, album names
- Genre specifications (e.g., "rock", "jazz", "pop")
- Mood or style descriptors (e.g., "upbeat", "relaxing", "energetic")
- Year ranges (e.g., "year:2020-2023")
- Any combination of the above

Examples of good search queries:
- "upbeat pop songs"
- "relaxing jazz piano"
- "rock songs from the 90s"
- "workout music electronic"
- "acoustic guitar ballads"

Do not be overly restrictive - Spotify's search is quite flexible and can handle natural language queries well.`,
      ...
      parameters: {
        ...
        properties: {
          q: {
            type: "string",
            description: "The search query string. This should be a natural language query that captures what the user is looking for in terms of music style, genre, mood, or specific artists/songs.",
          },
          type: {
            type: "string",
